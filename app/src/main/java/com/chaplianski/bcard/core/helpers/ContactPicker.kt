...
class ContactPicker @Inject constructor(
    ...
    private val pickFileLauncher = activityResultRegistry.register(
        LoadCardDialog.REGISTRY_KEY_LOAD_FILE,
...
//            val cardList = if (contentResolver != null) {
//                processVcard.convertVcardToCardList(readVcard, contentResolver,context)
//            } else emptyList<Card>()
//            callback.invoke(cardList)
//        }
    }

//    fun loadFiles(){pickFileLauncher.launch (arrayOf("*/*"))}
    fun checkReadFilesPermission(){pickFileLauncher.launch (arrayOf("*/*"))}
