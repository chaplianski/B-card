...
class CardsFragmentViewModelFactory @Inject constructor(private val getCardUseCase: GetCardsUseCase, private val addCardUseCase: AddCardUseCase): ViewModelProvider.Factory {
