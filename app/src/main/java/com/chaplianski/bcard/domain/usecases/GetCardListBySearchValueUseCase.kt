...
class GetCardListBySearchValueUseCase @Inject constructor(private val cardRepository: CardRepository) {

    fun execute (searchValue: String) = resultOf {
        Log.d("MyLog", "cardList 3")
        cardRepository.getCardListBySearchValue(searchValue)
    }
